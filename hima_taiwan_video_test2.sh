			...
			then
				...
				xcount=$(($xcount+1));
                        ...
                        then
                                ...
                                do
                                        fname=${f##*/}
                                        magick ../${previous_d}/${previous_i}/${fname} ../${previous_d}/${previous_i}/${fname} ../${previous_d}/${previous_i}/${fname} $f -evaluate-sequence mean 'C:\cygwin64\tmp\'himawari_${counter}_${fname}
                                done
                                xcount=$(($xcount+1));
