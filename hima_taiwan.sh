...
then
	...
	then
		...
		do
			...
			curl -f -s --retry 5 --retry-delay 5 --retry-max-time 60 --create-dirs -H 'User-Agent: Test' $url/geocolor/{${chunk}}/04/[002-005]_[003-008].png -o download/${date2}/#1/#2_#3.png
