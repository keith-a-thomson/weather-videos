...
declare -a arr=(
				...
				"Goes_16_Meso_01_Vis,toh265_archive.sh" 
				"Goes_16_Meso_02_Vis,toh265_archive.sh" 
				#"Goes_16_Meso_01_IR,toh265_archive_60fps.sh"
				#"Goes_16_Meso_02_IR,toh265_archive_60fps.sh"
				"Goes_17_Meso_01_Vis,toh265_archive.sh"
				"Goes_17_Meso_02_Vis,toh265_archive.sh"
				"Himawari_Mesoscale,toh265_archive_60fps.sh" 
...
do
	...
	if [ ! -f x265_crf28_${file}_$1$2.mp4 ];
	then
